...
function SignUp() {
    ...
    function MakePost() {
        ...
        Axios.post("https://localhost:7119/api/Users/SingUp", { Name, Email, Password, Phone, Address1, Address2, City, State, PostalCode, Country })
            .then(
                (res) => {
                        ...
                        <table width="30%">
                            <tr>
                                <td>
                                    ...
                                    <div className="form-group">
                                        <button type="button" className="btn btn-success" onClick={() => MakePost()}>Sign Up</button>
                                    </div>
                                </td>
                            </tr>
                        </table>
